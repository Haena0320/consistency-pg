...
annotPATH = '/mnt3/user15/VCR_data/'
imagePATH = '/mnt3/user16/VCR_data/vcr1images/'
...
class VcrDetectFeatTxtTokDataset(DetectFeatTxtTokDataset):
    def __init__(self, txt_db, img_db_gt=None, img_db=None):
        ...
        # self.db = lmdb.open(img_db, readonly=True, create=False) # /mnt2/user15/VILLA/vcr_data/img_db_cb
