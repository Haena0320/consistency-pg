...
from adapters.adapter_utils import *
...
#ACT2FN = {"gelu": gelu, "relu": torch.nn.functional.relu, "swish": swish, "leakyrelu":torch.nn.functional.leaky_relu}
...
class BertSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        self.retain_grad = config.retain_grad
...
class BertSelfOutput(nn.Module):
    def __init__(self, config, use_adapter):
        ...
        #     self.adapter = AdapterController(config, place="under")
        # else:
        #     self.adapter = None
        self.adapter = None
    ...
    def forward(self, hidden_states, input_tensor, task):
        ...
        if self.adapter is not None:
           hidden_states = self.adapter(hidden_states, input_tensor, task)
...
class BertAttention(nn.Module):
    def __init__(self, config, use_adapter):
        ...
        self.output = BertSelfOutput(config, use_adapter)
...
class BertOutput(nn.Module):
    ...
    def forward(self, hidden_states, input_tensor, task):
        hidden_states = self.dense(hidden_states)
        #hidden_states_raw = self.dropout(hidden_states)
        #hidden_states = self.LayerNorm(hidden_states_raw + input_tensor)
...
class BertLayer(nn.Module):
    def __init__(self, config, use_adapter):
        ...
        self.attention = BertAttention(config, use_adapter)
        self.intermediate = BertIntermediate(config)
        self.output = BertOutput(config, use_adapter)
